...
public class CurriculumManager
{
    ...
    private int level = 0;
    public float[] average_to_pass = new float[] { 0.5f, 0.5f, 0.4f, 0.3f, 0.2f, 0.2f};
    public Dictionary<string, float[]> parameters = new Dictionary<String, float[]>()
    {
        {"car_pos_offset",  new float[]{0, 10, 20, 10, 20, 30, 0}},
        {"car_rot_offset",  new float[]{0, 5,  10, 20, 45, 90, 180}},
        {"car_vel_offset",  new float[]{0, 0,  0,   2,  5,  7, 7}},
        {"ball_pos_offset", new float[]{0, 5,  10, 10, 20, 30, 0}},
        {"total_random",    new float[]{0, 0,   0,  0,  0,  0, 1}},
        {"ball_rot_offset", new float[]{0, 0,   0,  2,   3, 4, 4}},
        {"ball_vel_offset", new float[]{0, 0,   0,  2,   3, 4, 4}}
    };
    ...
    private void UpdateStatus()
    {
        ...
        if (level < average_to_pass.Length && average > average_to_pass[level])
        {
